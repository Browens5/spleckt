...
- Set frames/sec (video), an optional start/end time or start/end frame export window, face size, FOV, faces per frame, top/bottom inclusion, yaw, layout (separate / strip / cross), and image format
